...
Setup name
	- bei irgendeiner Aenderung: * hinzufügen	
...
//	classvar <clockChecker;
	...
	*startDSP {
	...
	//	MXGlobals.sampleRateOnBoot = MXGlobals.server.sampleRate;
		...
		MXGlobals.server.sync(startcondition);
		startcondition.hang(1);  // otherwise meters don't start properly ...
